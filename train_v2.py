...
from dataloader import AneurysmDataset
...
if __name__ == '__main__':
    #-----------------------Training--------------------------------------
    mri_data_train = AneurysmDataset("../Aneurysm_data", (64, 64, 64), train=True)
    trainloader = dataloader.DataLoader(mri_data_train, batch_size=batch_train, shuffle=True)
    mri_data_val = AneurysmDataset("../Aneurysm_data", (64, 64, 64), train=False)
